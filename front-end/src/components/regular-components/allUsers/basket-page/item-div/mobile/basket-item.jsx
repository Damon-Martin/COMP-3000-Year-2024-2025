...
export default function BasketItemMobile({
    ...
    return (
        <div
            key={key}
            className="bg-[#D9D9D9] text-black mt-4 min-w-[93vw] max-w-[93vw] min-h-[15vh] max-h-[15vh] rounded-md flex items-center justify-between"
        >
            ...
            <div className="flex items-center">
                <Image
                    ...
                    placeholder="blur"
                    alt={altTxtImage}
                    className="rounded-md min-h-[15vh] max-h-[15vh] min-w-[30vw] max-w-[30vw]"
                />
